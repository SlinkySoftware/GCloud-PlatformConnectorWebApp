/*
 *   platformconnector - GCloudPlatformConnectorApplication.java
 *
 ...
 *
 */
package com.slinkytoybox.gcloud.platformconnector;
...
@Slf4j
public class GCloudPlatformConnectorApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(GCloudPlatformConnectorApplication.class, args);
    ...
    public void setLogo(String consoleLogo) {
        synchronized (logoLock) {
            GCloudPlatformConnectorApplication.consoleLogo = consoleLogo;
        }
